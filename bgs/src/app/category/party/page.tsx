    ...
    return (
        <>
            ...
            <div className="mt-74px">
                <div className="mt-5">
                    <div className="ml-10 mr-10 pt-3 pb-3 text-3xl font-semibold">Party Board Games</div>
                        ...
                        <div className="flex flex-row justify-center">
                            ...
                            <div className="ml-10 mr-10 ">
                                <Image
                                    ...
                                    alt="Picture of ThatNotHat game"
                                />
                                <h1 className="mt-3 flex text-lg font-semibold">One Night Daybreak</h1>
                                <h1 className="flex text-sm font-semibold">850 Baht</h1>
                                <div className="flex items-center justify-center ">
                                    <button
                                        className="inline-flex w-full items-center justify-center bg-[#0899E7] hover:bg-[#0B87B2] text-white font-bold py-1 px-2 border border-b-2 border-gray-600 rounded-full shadow-2xl text-lg 
                                            focus:shadow font-medium mb-5 mt-3 ">
                            ...
                            <div className="ml-10 mr-10 ">
                                <Image
                                    ...
                                    alt="Picture of ThatNotHat game"
                                />
                                <h1 className="mt-3 flex text-lg font-semibold">Exploding Minions</h1>
                                <h1 className="flex text-sm font-semibold">950 Baht</h1>
                                <div className="flex items-center justify-center ">
                                    <button
                                        className="inline-flex w-full items-center justify-center bg-[#0899E7] hover:bg-[#0B87B2] text-white font-bold py-1 px-2 border border-b-2 border-gray-600 rounded-full shadow-2xl text-lg 
                                            focus:shadow font-medium mb-5 mt-3 ">
